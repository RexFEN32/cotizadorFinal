...
class DoubleDeepTypeStructuralJoistController extends Controller
{
    public function caliber14_show($id)
    {
        ...
        return view('quotes.double_deep.joists.typestructuraljoists.caliber14.index', compact(
            'Joists',
            'Calibers',
            'Lengths',
            'Cambers',
    ...
    public function caliber14_calc(Request $request)
    {
        ...
        if($Cambers){
            ...
            $SJS = DoubleDeepJoistStructural::where('quotation_id', $Quotation_Id)->first();
            if($SJS){
                $SJS->amount = $Amount;
                $SJS->caliber = $Caliber;
                ...
                $SJS = new DoubleDeepJoistStructural();
            ...
            return view('quotes.double_deep.joists.typestructuraljoists.caliber14.store', compact(
                'Amount',
                'Weight',
                'JoistType',
                'Length',
            ...
            return redirect()->route('double_deep_menujoists.show', $Quotation_Id)->with('no_existe', 'ok');
        }
    ...
    public function store(Request $request)
    {
        ...
        if($TypeLJoists){
            ...
            return view('quotes.double_deep.joists.typestructuraljoists.store', compact(
                'Amount',
                'Caliber',
                'Length',
                'Camber',
    ...
    public function show($id)
    {
        ...
        return view('quotes.double_deep.joists.typestructuraljoists.index', compact(
            'Joists',
            'Calibers',
            'Lengths',
            'Cambers',
