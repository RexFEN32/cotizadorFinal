...
class DoubleDeepTypeL25JoistController extends Controller
{
    public function caliber14_show($id)
    {
        ...
        return view('quotes.double_deep.joists.typel25joists.caliber14.index', compact(
            'Joists',
            'Calibers',
            'Lengths',
            'Cambers',
    ...
    public function caliber14_calc(Request $request)
    {
        ...
        if($Cambers){
            ...
            $SJL25C14 = DoubleDeepJoistL25Caliber14::where('quotation_id', $Quotation_Id)->first();
            if($SJL25C14){
                ...
                $SJL25C14 = new DoubleDeepJoistL25Caliber14();
            ...
            return view('quotes.double_deep.joists.typel25joists.caliber14.store', compact(
                'Amount',
                'Weight',
                'JoistType',
                'Length',
    ...
    public function store(Request $request)
    {
        ...
        $SJL25 = DoubleDeepJoistL25::where('quotation_id', $Quotation_Id)->first();
        if($SJL25){
            $SJL25->amount = $Amount;
        ...
        return view('quotes.double_deep.joists.typel25joists.store', compact(
            'Amount',
            'Caliber',
            'Length',
            'Camber',
    ...
    public function show($id)
    {
        ...
        return view('quotes.double_deep.joists.typel25joists.index', compact(
            'Joists',
            'Calibers',
            'Lengths',
            'Cambers',
