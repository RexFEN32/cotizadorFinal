...
class DoubleDeepTypeL2JoistController extends Controller
{
    public function caliber14_show($id)
    {
        ...
        return view('quotes.double_deep.joists.typel2joists.caliber14.index', compact(
            'Joists',
            'Calibers',
            'Lengths',
            'Cambers',
    ...
    public function caliber14_calc(Request $request)
    {
        ...
        if($Cambers){
            ...
            $SJL2 = DoubleDeepJoistL2Caliber14::where('quotation_id', $Quotation_Id)->first();
            if($SJL2){
                $SJL2->amount = $Amount;
                ...
                $SJL2 = new DoubleDeepJoistL2Caliber14();
            ...
            return view('quotes.double_deep.joists.typel2joists.caliber14.store', compact(
                'Amount',
                'Weight',
                'JoistType',
                'Length',
    ...
    public function store(Request $request)
    {
        ...
        $SJL2 = DoubleDeepJoistL2::where('quotation_id', $Quotation_Id)->first();
        if($SJL2){
            $SJL2->amount = $Amount;
            $SJL2->caliber = $Caliber;
            $SJL2->skate = $Skate;
        ...
        return view('quotes.double_deep.joists.typel2joists.store', compact(
            'Amount',
            'Caliber',
            'Length',
            'Camber',
    ...
    public function show($id)
    {
        ...
        return view('quotes.double_deep.joists.typel2joists.index', compact(
            'Joists',
            'Calibers',
            'Lengths',
            'Cambers',
