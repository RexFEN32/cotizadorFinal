                            ...
                            <table style="border: solid 1px">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: solid 1px" width="50%">
                                            @if($DoubleDeepHeavyLoadFramesTotalLoadKg)
                                                Marco Carga Pesada: {{ $DoubleDeepHeavyLoadFramesTotalLoadKg }} <br>
                                            @endif
                                            @if($DoubleDeepMiniatureFramesTotalLoadKg)
                                                Minimarco: {{ $DoubleDeepMiniatureFramesTotalLoadKg }} <br>
                                            @endif
                                            @if($DoubleDeepStructuralFramesTotalLoadKg)
                                                Marco Estructural: {{ $DoubleDeepStructuralFramesTotalLoadKg }} <br>
                                            @endif
                                            @if($DoubleDeepJoistBox2Caliber14STotalLoadKg)
                                                Viga Tipo Caja 2.0 Calibre 14: {{ $DoubleDeepJoistBox2Caliber14STotalLoadKg }} <br>
                                            @endif
                                            @if($DoubleDeepJoistBox2STotalLoadKg)
                                                Viga Tipo Caja 2.0: {{ $DoubleDeepJoistBox2STotalLoadKg }} <br>
                                            @endif
                                            @if($DoubleDeepJoistBox25Caliber14STotalLoadKg)
                                                Viga Tipo Caja 2.5 Calibre 14: {{ $DoubleDeepJoistBox25Caliber14STotalLoadKg }} <br>
                                            @endif
                                            @if($DoubleDeepJoistBox25STotalLoadKg)
                                                Viga Tipo Caja 2.5: {{ $DoubleDeepJoistBox25STotalLoadKg }} <br>
                                            @endif
                                            @if($DoubleDeepJoistC2STotalLoadKg)
                                                Viga Tipo C 2.5: {{ $DoubleDeepJoistC2STotalLoadKg }} <br>
                                            @endif
                                            @if($DoubleDeepJoistChairsTotalLoadKg)
                                                Viga Tipo Silla: {{ $DoubleDeepJoistChairsTotalLoadKg }} <br>
                                            @endif
                                            @if($DoubleDeepJoistL2Caliber14STotalLoadKg)
                                                Viga Tipo L 2.0 Calibre 14: {{ $DoubleDeepJoistL2Caliber14STotalLoadKg }} <br>
                                            @endif
                                            @if($DoubleDeepJoistL2STotalLoadKg)
                                                Viga Tipo L 2.0: {{ $DoubleDeepJoistL2STotalLoadKg }} <br>
                                            @endif
                                            @if($DoubleDeepJoistL25Caliber14STotalLoadKg)
                                                Viga Tipo L 2.5 Calibre 14: {{ $DoubleDeepJoistL25Caliber14STotalLoadKg }} <br>
                                            @endif
                                            @if($DoubleDeepJoistL25STotalLoadKg)
                                                Viga Tipo L 2.5: {{ $DoubleDeepJoistL25STotalLoadKg }} <br>
                                            @endif
                                            @if($DoubleDeepJoistLrsTotalLoadKg)
                                                Viga Tipo LRS: {{ $DoubleDeepJoistLrsTotalLoadKg }} <br>
                                            @endif
                                            @if($DoubleDeepJoistStructuralsTotalLoadKg)
                                                Viga Estructural: {{ $DoubleDeepJoistStructuralsTotalLoadKg }} <br>
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
