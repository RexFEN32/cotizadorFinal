    ...
    <div class="container w-full bg-white p-3 rounded-xl shadow-xl">
        <div class="row m-3">
            ...
            <div  class="row bg-white p-4 shadow-lg rounded-lg">
                {!! Form::open(['method'=>'POST','route'=>['double_deep_floor_reinforcements.calc']]) !!}
                <input type="hidden" name="Quotation_Id" value="{{$Quotation_Id}}">
                <div class="row">
                    <div class="col-sm-8 col-xs-12">
                        <h2><i class="fa-solid fa-puzzle-piece"></i>&nbsp;Refuerzo para Pisos</h2>
                    ...
                    <div class="col-sm-4 col-xs-12">
                        <div class="form-group p-2">
                            ...
                            <select name="piece" class="js_select2 inputjet w-full text-xs uppercase">
                                @foreach ($FloorReinforcements as $row)
                                    <option value="{{$row->id}}"@if (old('piece')==$row->length) selected @endif>{{$row->length}}</option>
                                @endforeach
                            </select>
