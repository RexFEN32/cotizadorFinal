            ...
            <div  class="row bg-white p-4 shadow-lg rounded-lg">
                ...
                <div class="col-sm-6 col-xs-12">
                    ...
                    <div class="form-group p-2 gap-2 flex items-center">
                        <a href="{{route('double_deep_special.index', $Special->quotation_id)}}" class="btn btn-blue mb-2">
                            <i class="fa-solid fa-right-left fa-xl"></i>&nbsp; Corregir
                        </a>
                        <a href="{{route('double_deep.show', $Special->quotation_id)}}" class="btn btn-black mb-2">
