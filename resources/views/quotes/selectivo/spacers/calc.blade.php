                ...
                <div class="col-sm-8 col-xs-12">
                    <div class="form-group p-2 text-sm font-semibold table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <td class="text-left font-bold">Tornillos: </td>
                                <td>{{$CantidadTornillos}}</td>
                            </tr>
                            <tr>
                                <td class="text-left font-bold text-lg">Costo Total de Tornillos: </td>
                                <td class="text-left font-bold text-lg">${{number_format($CostoTotalTornillos, 2)}}</td>
                            </tr>
                            <tr>
                                <td class="text-left font-bold">Costo x Unidad: </td>
                                <td>${{number_format($PriceUnit, 2)}}</td>
                            </tr>
                            <tr>
                    ...
                    <div class="form-group p-2 gap-2 flex items-center">
                        ...
                        <a href="{{route('spacers.add_carrito', $Quotation_Id)}}" class="btn btn-black mb-2">
