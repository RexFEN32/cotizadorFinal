...
@section('content')
    <div class="container w-full bg-white p-3 rounded-xl shadow-xl">
        <div class="row m-3">
            {!! Form::open(['method'=>'POST','route'=>['selectivo_protectors.store']]) !!}
            ...
            <div  class="row bg-white p-4 shadow-lg rounded-lg">
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group p-2">
                        ...
                        <select name="protector" class="inputjet w-full text-xs uppercase">
                            @foreach ($Protectors as $row)
                                <option value="{{$row->protector}}"@if (old('protector')==$row->protector) selected @endif>{{$row->protector}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group p-2 gap-2 flex items-center">
                        ...
                        <a href="{{route('selectivo_protectors.index', $Quotation_Id)}}" class="btn btn-black mb-2">
