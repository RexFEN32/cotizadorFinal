                            ...
                            <div class="row">
                                <div class="col gap-1 inline-flex">
                                    <div class="form-group">
                                        ...
                                        <x-jet-input type="text" name="a8" value="{{$Questionarys->a8}}" class="w-flex uppercase"/>
                                        <x-jet-input-error for='a8' />
                                    </div>
                                    <div class="form-group">
                                        <x-jet-label value="Fondo" />
                                        <x-jet-input type="text" name="a9" value="{{$Questionarys->a9}}" class="w-flex uppercase"/>
                                        <x-jet-input-error for='a9' />
                                    </div>
                                    <div class="form-group">
                                        <x-jet-label value="Alto" />
                                        <x-jet-input type="text" name="a10" value="{{$Questionarys->a10}}" class="w-flex uppercase"/>
                                        <x-jet-input-error for='a10' />
                                    </div>
                                    <div class="form-group">
                                        <x-jet-label value="Peso" />
                                        <x-jet-input type="text" name="a11" value="{{$Questionarys->a11}}" class="w-flex uppercase"/>
