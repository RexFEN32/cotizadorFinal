...
@section('content_header')
    <h1 class="font-bold"><i class="fas fa-edit"></i>&nbsp; Editar Clasificación</h1>
@stop
...
@section('content')
    <div class="container bg-gray-300 shadow-lg rounded-lg">
        ...
        {!! Form::open(['method'=>'PUT','route'=>['customer_classifications.update',$customer_classification->id]]) !!}
        <div class="row p-4 rounded-b-lg rounded-t-none mb-4 shadow-xl bg-gray-300">
            <div class="col-xs-12 p-2 gap-2">
                <div class="form-group">
                    ...
                    {!! Form::text('customer_classification',$customer_classification->customer_classification, ['class'=>'inputjet w-full text-xs uppercase']) !!}
