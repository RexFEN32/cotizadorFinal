...
@section('content_header')
    <h1 class="font-bold"><i class="fas fa-plus-circle"></i>&nbsp; Agregar Factor</h1>
@stop
    ...
    <div class="container bg-gray-300 shadow-lg rounded-lg">
        <div class="row p-4 rounded-b-none rounded-t-lg shadow-xl bg-white">
            <h5 class="card-title p-2">
                <i class="fas fa-plus-circle"></i>&nbsp; Agregar Factor
            </h5>
        </div>
        {!! Form::open(['method'=>'POST','route'=>['factors.store']]) !!}
        <div class="row p-4 rounded-b-lg rounded-t-none mb-4 shadow-xl bg-gray-300">
            ...
            <div class="col-xs-12 p-2 gap-2">
                <div class="form-group">
                    ...
                    {!! Form::number('factor',old('factor'), ['class'=>'inputjet w-full text-xs', 'step'=>'0.1']) !!}
