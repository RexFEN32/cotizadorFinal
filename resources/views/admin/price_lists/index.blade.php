    ...
    <div class="container-flex m-1 bg-gray-300 shadow-lg rounded-lg">
        <div class="row p-3 m-2 rounded-lg shadow-xl bg-white">
            <div class="col-sm-12 text-right">
                ...
                <a href="{{ route('price_lists.create')}}" class="btn btn-green">
            ...
            <div class="col-sm-12 table-responsive">
                <table class="table tableprice_lists table-striped text-xs">
                                ...
                                <div class="row">
                                    <div class="col-6 text-center w-10">
                                        @can('EDITAR LISTA DE PRECIOS')
                                            <a href="{{ route('price_lists.edit', $row->id)}}" class="btn btn-blue w-9 h-9">
                                    ...
                                    <div class="col-6 text-center w-10">
                                        ...
                                        {!! Form::open(['method'=>'DELETE','route'=>['price_lists.destroy', $row->id], 'class'=>'DeleteReg' ]) !!}
...
@section('js')
<script type="text/javascript" src="{{ asset('vendor/mystylesjs/js/tablecatalogoprice_lists.js') }}"></script>
